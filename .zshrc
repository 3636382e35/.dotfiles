...
wal -q -i ~/.config/wallpapers/inanis.jpg
...
alias lex="lexido"
alias mp3="yt-dlp --extract-audio --audio-format mp3 --audio-quality 0 -o '$HOME/Downloads/Music/%(title)s.%(ext)s'"
# alias the termusic with 'music'
alias music="termusic"
alias music-conf="vim ~/.config/termusic/config.toml"
...
xping() {
    ping "$1"| grep -oP 'time=\K\S+' 
}
alias pingl="ping google.com"
